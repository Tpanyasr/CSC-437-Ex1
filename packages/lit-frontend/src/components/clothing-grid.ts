...
@customElement("clothing-grid")
export class ClothingGrid extends LitElement {
  render() {
    return html`
      <div class="container_items">
        ...
        >
          <img
            slot="image"
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS0umZCwz2-zJu343QE1qX-plkbppqkVfLvdg&usqp=CAU"
            alt="Clothing Image"
            class="card-img"
          />
        </clothing-card>
        ...
        >
          <img
            slot="image"
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ9KvXyW17lWNQrOZLz1aQ_PEOO6yxNSMpjNg&usqp=CAU"
            alt="Clothing Image"
            class="card-img"
          />
        </clothing-card>
